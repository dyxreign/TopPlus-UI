...
function TabClass:Input(options)
    ...
    boxBg.BackgroundColor3 = isLight and Color3.fromRGB(200, 200, 205) or Color3.fromRGB(15, 15, 18)
...
function TabClass:Paragraph(options)
    ...
    if hasButtons then
        ...
        for i, btnData in ipairs(btns) do
            ...
            pBtn.BackgroundColor3 = isLight and Color3.fromRGB(200, 200, 205) or Color3.fromRGB(35, 35, 40)
...
function TabClass:Dropdown(options)
    ...
    selectBtn.BackgroundColor3 = isLight and Color3.fromRGB(200, 200, 205) or Color3.fromRGB(35, 35, 40)
    ...
    for i, optName in ipairs(optionList) do
        ...
        optBtn.BackgroundColor3 = isLight and Color3.fromRGB(200, 200, 205) or Color3.fromRGB(30, 30, 35)
        optBtn.Text = "  " .. optName
